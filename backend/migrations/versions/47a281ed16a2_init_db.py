...
def upgrade() -> None:
    ...
    op.create_table('booking_points',
    ...
    op.create_index(op.f('ix_booking_points_id'), 'booking_points', ['id'], unique=False)
    ...
    sa.Column('condition', sa.Enum('EXCELLENT', 'GOOD', 'FAIR', 'POOR', name='bookcondition'), nullable=False),
    ...
    sa.Column('status', sa.Enum('PENDING', 'CONFIRMED', 'TAKEN', 'RETURNED', 'CANCELLED', name='bookingstatus'), nullable=False),
    ...
    sa.ForeignKeyConstraint(['booking_point_id'], ['booking_points.id'], ),
    ...
    sa.Column('type', sa.Enum('BOOKING_CREATED', 'RETURN_REMINDER', 'BOOK_AVAILABLE', 'BOOKING_CANCELLED', name='notificationtype'), nullable=False),
    sa.Column('title', sa.String(length=255), nullable=False),
