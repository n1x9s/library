...
from app.schemas.booking import (
    ...
    BookingSearchParams, BookingStatusUpdate
)
...
async def get_booking(
    ...
    book = booking.book
    if not book or (book.owner_id != current_user_id and booking.borrower_id != current_user_id):
        raise HTTPException(
...
async def update_booking_status(
    ...
    booking_service = BookingService(db)
    booking = booking_service.update_booking_status(booking_id, status_data.status, current_user_id)
